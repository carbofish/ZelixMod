...
public final class Log {
	...
	/** true if activated by the system property "net.utils.slick.forceVerboseLog" */
	 ...
	 * value must be "true"
	 */
	private static final String forceVerboseProperty = "net.utils.slick.forceVerboseLog";
	 ...
	 * "net.utils.slick.forceVerboseLog"
	 * 
	...
	/**
	 * Check if the system property net.utils.slick.verboseLog is set to true.
	 ...
	 * Only be called when system property "net.utils.slick.forceVerboseLog" is set to true.
