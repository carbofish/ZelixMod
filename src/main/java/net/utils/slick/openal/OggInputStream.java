...
public class OggInputStream extends InputStream implements AudioInputStream {
	...
	/**
	 * @see net.utils.slick.openal.AudioInputStream#getChannels()
	 */
	...
	/**
	 * @see net.utils.slick.openal.AudioInputStream#getRate()
	 */
	public int getRate() {
		return oggInfo.rate;
	}
	...
	/**
	 * @see net.utils.slick.openal.AudioInputStream#atEnd()
	 */
