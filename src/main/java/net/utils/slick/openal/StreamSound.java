...
public class StreamSound extends AudioImpl {
	...
	/**
	 * @see net.utils.slick.openal.AudioImpl#isPlaying()
	 */
	...
	/**
	 * @see net.utils.slick.openal.AudioImpl#playAsMusic(float, float, boolean)
	 */
	...
	/**
	 * @see net.utils.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean, float, float, float)
	 */
	...
	/**
	 * @see net.utils.slick.openal.AudioImpl#playAsSoundEffect(float, float, boolean)
	 */
	...
	/**
	 * @see net.utils.slick.openal.AudioImpl#stop()
	 */
	public void stop() {
	...
	/**
	 * @see net.utils.slick.openal.AudioImpl#setPosition(float)
	 */
	...
	/**
	 * @see net.utils.slick.openal.AudioImpl#getPosition()
	 */
