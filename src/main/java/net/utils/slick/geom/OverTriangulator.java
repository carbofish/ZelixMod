...
public class OverTriangulator implements Triangulator {
	...
	/**
	 * @see net.utils.slick.geom.Triangulator#addPolyPoint(float, float)
	 */
	public void addPolyPoint(float x, float y) {
	}

	/**
	 * @see net.utils.slick.geom.Triangulator#getTriangleCount()
	 */
	...
	/**
	 * @see net.utils.slick.geom.Triangulator#getTrianglePoint(int, int)
	 */
	...
	/**
	 * @see net.utils.slick.geom.Triangulator#startHole()
	 */
	public void startHole() {
	}

	/**
	 * @see net.utils.slick.geom.Triangulator#triangulate()
	 */
