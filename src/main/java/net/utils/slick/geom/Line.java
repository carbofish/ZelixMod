...
public class Line extends Shape {
	...
	/**
	 * @see net.utils.slick.geom.Shape#getX()
	 */
	public float getX() {
		return getX1();
	}
	...
	/**
	 * @see net.utils.slick.geom.Shape#getY()
	 */
	public float getY() {
		return getY1();
	}
	...
	/**
	 * @see net.utils.slick.geom.Shape#createPoints()
	 */
	...
	/**
	 * @see net.utils.slick.geom.Shape#transform(net.utils.slick.geom.Transform)
	 */
	...
	/**
	 * @see net.utils.slick.geom.Shape#closed()
	 */
	...
	/**
	 * @see net.utils.slick.geom.Shape#intersects(net.utils.slick.geom.Shape)
	 */
