...
public class MouseOverArea extends AbstractComponent {
	...
	/**
	 * @see net.utils.slick.gui.AbstractComponent#render(net.utils.slick.gui.GUIContext,
	 *      net.utils.slick.Graphics)
	 */
	...
	/**
	 * @see net.utils.slick.util.InputAdapter#mouseMoved(int, int, int, int)
	 */
	...
	/**
	 * @see net.utils.slick.util.InputAdapter#mouseDragged(int, int, int, int)
	 */
