package net.utils.slick.imageout;
...
public class TGAWriter implements ImageWriter {
	...
	/**
	 * @see net.utils.slick.imageout.ImageWriter#saveImage(net.utils.slick.Image, java.lang.String, java.io.OutputStream, boolean)
	 */
