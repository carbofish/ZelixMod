...
public class OutlineWobbleEffect extends OutlineEffect {
	...
	/**
	 * @see net.utils.slick.font.effects.OutlineEffect#toString()
	 */
	...
	/**
	 * @see net.utils.slick.font.effects.OutlineEffect#getValues()
	 */
	...
	/**
	 * @see net.utils.slick.font.effects.OutlineEffect#setValues(java.util.List)
	 */
