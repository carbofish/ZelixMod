...
public class SpriteSheetFont implements Font {
	...
	/**
	 * @see net.utils.slick.Font#drawString(float, float, java.lang.String)
	 */
	...
	/**
	 * @see net.utils.slick.Font#drawString(float, float, java.lang.String, net.utils.slick.Color)
	 */
	...
	/**
	 * @see net.utils.slick.Font#getLineHeight()
	 */
