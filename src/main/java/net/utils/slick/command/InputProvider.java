...
import net.utils.slick.util.InputAdapter;
...
public class InputProvider {
	...
	private class InputListenerImpl extends InputAdapter {
		/**
		 * @see net.utils.slick.util.InputAdapter#isAcceptingInput()
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#keyPressed(int, char)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#keyReleased(int, char)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#mousePressed(int, int, int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#mouseReleased(int, int, int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerLeftPressed(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerLeftReleased(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerRightPressed(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerRightReleased(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerUpPressed(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerUpReleased(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerDownPressed(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerDownReleased(int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerButtonPressed(int,
		 *      int)
		 */
		...
		/**
		 * @see net.utils.slick.util.InputAdapter#controllerButtonReleased(int,
		 *      int)
		 */
