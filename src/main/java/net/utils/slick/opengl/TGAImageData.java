...
public class TGAImageData implements LoadableImageData {
	...
	/**
	 * @see net.utils.slick.opengl.ImageData#getDepth()
	 */
	public int getDepth() {
		return pixelDepth;
	}
	...
	/**
	 * @see net.utils.slick.opengl.ImageData#getWidth()
	 */
	public int getWidth() {
		return width;
	}
	...
	/**
	 * @see net.utils.slick.opengl.ImageData#getHeight()
	 */
	...
	/**
	 * @see net.utils.slick.opengl.ImageData#getTexWidth()
	 */
	...
	/**
	 * @see net.utils.slick.opengl.ImageData#getTexHeight()
	 */
	...
	/**
	 * @see net.utils.slick.opengl.LoadableImageData#loadImage(java.io.InputStream)
	 */
	...
	/**
	 * @see net.utils.slick.opengl.LoadableImageData#loadImage(java.io.InputStream, boolean, int[])
	 */
	...
	/**
	 * @see net.utils.slick.opengl.LoadableImageData#loadImage(java.io.InputStream, boolean, boolean, int[])
	 */
	...
	/**
	 * @see net.utils.slick.opengl.ImageData#getImageBufferData()
	 */
	...
	/**
	 * @see net.utils.slick.opengl.LoadableImageData#configureEdging(boolean)
	 */
