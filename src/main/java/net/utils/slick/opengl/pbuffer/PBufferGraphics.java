package net.utils.slick.opengl.pbuffer;
...
public class PBufferGraphics extends Graphics {
	...
	/**
	 * @see net.utils.slick.Graphics#disable()
	 */
	...
	/**
	 * @see net.utils.slick.Graphics#enable()
	 */
	...
	/**
	 * @see net.utils.slick.Graphics#destroy()
	 */
	public void destroy() {
		super.destroy();
	...
	/**
	 * @see net.utils.slick.Graphics#flush()
	 */
	public void flush() {
		super.flush();
