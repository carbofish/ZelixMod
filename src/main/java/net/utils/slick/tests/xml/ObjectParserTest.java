package net.utils.slick.tests.xml;

import net.utils.slick.util.xml.ObjectTreeParser;
import net.utils.slick.util.xml.SlickXMLException;
...
public class ObjectParserTest {
	...
	public static void main(String[] argv) throws SlickXMLException {
		ObjectTreeParser parser = new ObjectTreeParser("net.utils.slick.tests.xml");
