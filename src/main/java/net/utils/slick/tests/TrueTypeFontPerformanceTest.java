...
import net.utils.slick.TrueTypeFont;
...
public class TrueTypeFontPerformanceTest extends BasicGame {
	...
	/**
	 * @see net.utils.slick.BasicGame#render(net.utils.slick.GameContainer,
	...
	/**
	 * @see net.utils.slick.BasicGame#update(net.utils.slick.GameContainer,
	 *      int)
	 */
