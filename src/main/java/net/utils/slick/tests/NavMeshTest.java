...
import net.utils.slick.util.pathfinding.Mover;
import net.utils.slick.util.pathfinding.PathFindingContext;
import net.utils.slick.util.pathfinding.TileBasedMap;
import net.utils.slick.util.pathfinding.navmesh.Link;
import net.utils.slick.util.pathfinding.navmesh.NavMesh;
import net.utils.slick.util.pathfinding.navmesh.NavMeshBuilder;
import net.utils.slick.util.pathfinding.navmesh.NavPath;
import net.utils.slick.util.pathfinding.navmesh.Space;
...
public class NavMeshTest extends BasicGame implements PathFindingContext {
	...
	/*
	 * (non-Javadoc)
	 * @see net.utils.slick.util.pathfinding.PathFindingContext#getMover()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.utils.slick.util.pathfinding.PathFindingContext#getSearchDistance()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.utils.slick.util.pathfinding.PathFindingContext#getSourceX()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.utils.slick.util.pathfinding.PathFindingContext#getSourceY()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.utils.slick.BasicGame#mousePressed(int, int, int)
	 */
	...
	private class DataMap implements TileBasedMap {
		...
		/*
		 * (non-Javadoc)
		 * @see net.utils.slick.util.pathfinding.TileBasedMap#blocked(net.utils.slick.util.pathfinding.PathFindingContext, int, int)
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see net.utils.slick.util.pathfinding.TileBasedMap#getCost(net.utils.slick.util.pathfinding.PathFindingContext, int, int)
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see net.utils.slick.util.pathfinding.TileBasedMap#getHeightInTiles()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see net.utils.slick.util.pathfinding.TileBasedMap#getWidthInTiles()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see net.utils.slick.util.pathfinding.TileBasedMap#pathFinderVisited(int, int)
		 */
