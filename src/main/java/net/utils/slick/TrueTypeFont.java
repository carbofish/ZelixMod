...
import net.utils.slick.opengl.GLUtils;
...
import net.utils.slick.util.BufferedImageUtil;
 ...
 */
public class TrueTypeFont implements net.utils.slick.Font {
	...
	public void drawString(float x, float y, String whatchars,
			net.utils.slick.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, net.utils.slick.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
                           net.utils.slick.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, net.utils.slick.Color.white);
	}
