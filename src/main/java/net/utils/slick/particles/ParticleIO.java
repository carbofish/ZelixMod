package net.utils.slick.particles;
...
import net.utils.slick.particles.ConfigurableEmitter.ColorRecord;
import net.utils.slick.particles.ConfigurableEmitter.LinearInterpolator;
import net.utils.slick.particles.ConfigurableEmitter.RandomValue;
import net.utils.slick.particles.ConfigurableEmitter.SimpleValue;
...
public class ParticleIO {
   ...
   public static ParticleSystem loadConfiguredSystem(InputStream ref,
		...
		try {
         ...
         if (system == null) {
         system = new ParticleSystem("net/utils/slick/data/particle.tga",
					2000, mask);
         }
