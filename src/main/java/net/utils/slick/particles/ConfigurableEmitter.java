...
import net.utils.slick.util.FastTrig;
...
public class ConfigurableEmitter implements ParticleEmitter {
	...
	/**
	 * @see net.utils.slick.particles.ParticleEmitter#update(net.utils.slick.particles.ParticleSystem,
	 *      int)
	 */
	...
	/**
	 * @see net.utils.slick.particles.ParticleEmitter#updateParticle(net.utils.slick.particles.Particle,
	 *      int)
	 */
