...
import net.utils.pw.tessellate.Tessellation;
...
public class RenderUtil
    ...
    public static final net.utils.pw.tessellate.Tessellation tessellator;
...
//		GL11.glEnd();
    ...
    public static void entityESPBox(EntityPlayer e, Color color, Event3D event) {
        double posX = e.lastTickPosX + (e.posX - e.lastTickPosX) * (double)event.parTicks - Helper.renderPosX();
        double posY = e.lastTickPosY + (e.posY - e.lastTickPosY) * (double)event.parTicks - Helper.renderPosY();
        double posZ = e.lastTickPosZ + (e.posZ - e.lastTickPosZ) * (double)event.parTicks - Helper.renderPosZ();
    ...
    public static void startDrawing() {
        ...
        GL11.glDisable(3553);
        GL11.glDisable(2929);
        ((IMixinEntityRenderer)(Instances.mc.entityRenderer)).setupCameraTransformwith(Helper.getTimer().renderPartialTicks, 0);
    }
