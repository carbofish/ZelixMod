...
public class EventController {
    ...
    /**
     * All methods in this class are static so there would be no reason to create an object of the EventController class.
     */
    public void init(List<Module> moduleList){
    ...
    private static void register(Method method, Object object) {
        ...
        final MethodData data = new MethodData(object, method, method.getAnnotation(Runnable.class).value());
    ...
    private static void sortListValue(Class<? extends Event> indexClass) {
        ...
        for (final byte priority : EventOrder.VALUE_ARRAY) {
    ...
    private static boolean isMethodBad(Method method) {
        return method.getParameterTypes().length != 1 || !method.isAnnotationPresent(Runnable.class);
    }
