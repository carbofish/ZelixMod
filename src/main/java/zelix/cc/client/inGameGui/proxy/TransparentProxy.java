        ...
        try {
            ...
            new Thread(() -> {
                try {
                    ...
                    this.failReason = e;
                    this.failed = true;
                    if (Instances.mc.currentScreen != null && Instances.mc.currentScreen instanceof GuiConnecting && ((IMixinGuiConnecting)((GuiConnecting)Instances.mc.currentScreen)).getNetworkManager() != null) {
                        ((IMixinGuiConnecting)((GuiConnecting)Instances.mc.currentScreen)).getNetworkManager().closeChannel(new ChatComponentText("Proxy failure"));
                    }
                    try {
                        this.client.close();
                    }
