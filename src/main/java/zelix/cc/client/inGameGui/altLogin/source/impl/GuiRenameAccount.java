...
import zelix.cc.injection.interfaces.IMixinGuiScreen;
...
public class GuiRenameAccount extends GuiScreen {
	...
	public void drawScreen(int par1, int par2, float par3) {
        ...
        FontRenderers.drawCenteredString("Edit Alt", width / 2, 10, -1);
        FontRenderers.drawCenteredString( status, width / 2, 20, -1);
	...
	public void initGui() {
        ...
        nameField = new GuiTextField(((IMixinGuiScreen)this).getEventButton(), mc.fontRendererObj, width / 2 - 100, 60, 200, 20);
